...
public class MovingRotorTest {
    ...
    public void checkRotorAdvance() {
        ...
        checkRotor("Rotor I advanced 25 times",
    ...
    public void checkRotorSet() {
        setRotor("I", NAVALA, "");
        rotor.set(25);
        checkRotor("Rotor I set to 25", UPPER_STRING, NAVALZ_MAP.get("I"));
        rotor.set(1);
        checkRotor("Rotor I set to 1", UPPER_STRING, NAVALB_MAP.get("I"));
    }
